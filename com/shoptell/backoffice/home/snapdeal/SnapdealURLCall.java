...
@Named
public class SnapdealURLCall {

	private static final Logger log = LoggerFactory.getLogger(SnapdealURLCall.class);

	@Inject
	private SnapdealProperties prop;

	public String queryService(String urlStr, boolean priceUpdate) throws Exception {
		...
		try {
			...
			con.setRequestProperty("Snapdeal-Token-Id", prop.getToken());
			con.setRequestProperty("Snapdeal-Affiliate-Id", prop.getTrackingID());
			if (priceUpdate){
