...
import com.shoptell.async.ExceptionHandlingAsyncTaskExecutor;
...
public class AsyncConfiguration implements AsyncConfigurer, EnvironmentAware {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setCorePoolSize(propertyResolver.getProperty("corePoolSize", Integer.class, 5));
        ...
        executor.setThreadNamePrefix("shoptell-Executor-");
