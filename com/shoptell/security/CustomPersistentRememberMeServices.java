...
import com.shoptell.domain.PersistentToken;
import com.shoptell.repository.PersistentTokenRepository;
...
public class CustomPersistentRememberMeServices extends
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication successfulAuthentication) {
        ...
        PersistentToken token = Optional.ofNullable(userRepository.findUserByLogin(login)).map(u -> {
